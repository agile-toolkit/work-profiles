...
- [ ] [#49] Feature: team overview tab — stat cards (member count, avg capacity, total skills, endorsements), role distribution bars, capacity histogram, SVG skill-category radar chart, most-endorsed skills list; pure SVG + Tailwind, no library (approved 2026-07-08 — includes OOO/timezone stats, static radar, supplements Dashboard card)
