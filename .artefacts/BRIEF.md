...
- [ ] [#48] UX: skill name autocomplete from team vocabulary — datalist or dropdown in ProfileForm reading existing skill names from localStorage; prevents "React" / "ReactJS" naming drift; no library, pure React state (approved 2026-07-08 — active profiles only, substring match, no proficiency annotation)
